...
int
_set_value_1 (set_value_args  *argp, void *result, struct svc_req *rqstp)
{
...
int
_modify_value_1 (set_value_args  *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		set_value_args set_value_1_arg;
		char *get_value_1_arg;
		set_value_args modify_value_1_arg;
		char *delete_key_1_arg;
		char *exist_1_arg;
	} argument;
	union {
		int set_value_1_res;
		get_value_res get_value_1_res;
